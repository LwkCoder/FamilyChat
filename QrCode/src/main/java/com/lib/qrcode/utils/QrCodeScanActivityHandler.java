 ...
 */
public class QrCodeScanActivityHandler extends Handler
{
    ...
    public QrCodeScanActivityHandler(QrCodeScanActivity activity, CameraManager cameraManager, int decodeMode)
    {
