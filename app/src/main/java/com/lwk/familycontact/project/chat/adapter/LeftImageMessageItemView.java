...
/**
 * Created by LWK
 * TODO 左边图片消息的ItemView
 * 2016/9/22
 */
public class LeftImageMessageItemView extends ImageMessageBaseItemView
{
    public LeftImageMessageItemView(Context mContext, HxChatPresenter mPresenter, UserBean mUserBean)
    {
    ...
    {
        return R.layout.layout_chat_left_image_listitem;
    }
