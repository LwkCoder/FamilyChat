 ...
 * 2016/9/22
 */
public class RightVoiceMessageItemView extends VoiceMessageBaseItemView
{
    public RightVoiceMessageItemView(Context mContext, HxChatPresenter mPresenter, UserBean mUserBean)
    {
    ...
    {
        return R.layout.layout_chat_right_voice_listitem;
    }
