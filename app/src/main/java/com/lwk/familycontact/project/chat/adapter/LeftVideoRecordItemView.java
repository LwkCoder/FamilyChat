...
/**
 * Created by LWK
 * TODO 左边视频通话记录ItemView
 * 2016/9/21
 */
public class LeftVideoRecordItemView extends TextMessageBaseItemView
{
    public LeftVideoRecordItemView(Context mContext, HxChatPresenter mPresenter, UserBean mUserBean)
    {
