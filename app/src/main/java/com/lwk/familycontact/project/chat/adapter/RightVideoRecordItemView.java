...
/**
 * Created by LWK
 * TODO 右边视频通话记录ItemView
 * 2016/9/22
 */
public class RightVideoRecordItemView extends TextMessageBaseItemView
{
    public RightVideoRecordItemView(Context mContext, HxChatPresenter mPresenter, UserBean mUserBean)
    {
    ...
    {
        return R.layout.layout_chat_right_video_record_listitem;
    }
