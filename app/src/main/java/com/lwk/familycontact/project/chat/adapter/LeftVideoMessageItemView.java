...
/**
 * Created by LWK
 * TODO 左边短视频消息ItemView
 * 2016/9/23
 */
public class LeftVideoMessageItemView extends VideoMessageBaseItemView
{
    public LeftVideoMessageItemView(Context mContext, HxChatPresenter mPresenter, UserBean mUserBean)
    {
    ...
    {
        if (item.direct() == EMMessage.Direct.RECEIVE && item.getType() == EMMessage.Type.VIDEO)
            return true;
        else
            return false;
    }
