...
public class UnicodeDialerKeyListener extends DialerKeyListener
{
    ...
    {
        final String converted = PhoneNumberUtils.convertKeypadLettersToDigits(replaceUnicodeDigits(source.toString()));
    ...
    protected String replaceUnicodeDigits(String number)
    {
