 ...
 *                     new OkPersistentCookieStore(getApplicationContext()),
 ...
 * <p/>
 * <br/>
 * A persistent cookie store which implements the Apache HttpClient OkCookieStore interface.
 ...
 */
public class OkPersistentCookieStore implements OkCookieStore
{

    private static final String LOG_TAG = "OkPersistentCookieStore";
     ...
     */
    public OkPersistentCookieStore(Context context)
    {
    ...
    protected void add(HttpUrl uri, Cookie cookie)
    {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + name, encodeCookie(new OkSerializableHttpCookie(cookie)));
        prefsWriter.apply();
    }
    ...
    protected String encodeCookie(OkSerializableHttpCookie cookie)
    {
        if (cookie == null)
            return null;
    ...
    protected Cookie decodeCookie(String cookieString)
    {
        ...
        try
        {
            ...
            cookie = ((OkSerializableHttpCookie) objectInputStream.readObject()).getCookie();
        } catch (IOException e)
        {
