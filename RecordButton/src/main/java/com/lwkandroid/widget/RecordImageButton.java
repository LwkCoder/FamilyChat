 ...
 */
public class RecordImageButton extends LinearLayout implements RecordAudioManager.PrepareListener
{
    //正常状态
    ...
    public RecordImageButton(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context);
    }
    ...
    {
        inflate(context, R.layout.layout_imgtxt, this);
    ...
    private void changeState(int state)
    {
        ...
        {
            case STATE_NORMAL:
                mImg.setImageResource(R.mipmap.icon_circle_friend_head_speach_normal);
                mTxt.setText(R.string.str_imgtxt_state_normal);
                mTxt.setTextColor(getResources().getColor(R.color.imgtxt_state_normal));
                break;
            case STATE_RECORDING:
                mImg.setImageResource(R.mipmap.icon_circle_friend_head_speach_pressed);
                mTxt.setText(R.string.str_imgtxt_state_recoding);
                mTxt.setTextColor(getResources().getColor(R.color.imgtxt_state_recording));
