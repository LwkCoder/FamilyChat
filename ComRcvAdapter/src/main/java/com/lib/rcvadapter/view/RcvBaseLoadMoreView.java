...
public abstract class RcvBaseLoadMoreView extends RelativeLayout
{
     ...
     * 加载失败后的状态
     */
    private final int STATUS_FAIL = 4;

    /**
     * 没有更多数据的状态
     */
    private final int STATUS_NOMOREDATA = 5;
     ...
     * 加载更多监听
     */
    private RcvMutilAdapter.onLoadMoreListener mListener;
     ...
     * 添加监听
     */
    public void setOnLoadMoreListener(RcvMutilAdapter.onLoadMoreListener loadMoreListener)
    {
