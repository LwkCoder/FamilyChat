package com.lib.rcvadapter.holder;
...
public class RcvHolder extends RecyclerView.ViewHolder
{
     ...
     * 为TextView设置字符串
     */
    public RcvHolder setTvText(int viewId, int resId)
    {
        TextView tv = findView(viewId);
        if (tv != null)
            tv.setText(resId);
     ...
     * 设置textview颜色
     */
    public RcvHolder setTvColor(int viewId, int textColor)
    {
        TextView tv = findView(viewId);
        if (tv != null)
     ...
     * 设置textview颜色【资源id】
     */
    public RcvHolder setTvColorRes(int viewId, int textColorRes)
    {
        TextView tv = findView(viewId);
        if (tv != null)
     ...
     * 设置button的文本【资源id】
     */
    public RcvHolder setBtnText(int viewId, int resId)
    {
        Button button = findView(viewId);
        if (button != null)
     ...
     * 为ImageView设置本地资源图片
     */
    public RcvHolder setImgResource(int viewId, int resId)
    {
     ...
     * 设置View背景色
     */
    public RcvHolder setBackgroundColor(int viewId, int color)
    {
        View view = findView(viewId);
     ...
     * 设置View的背景【资源id】
     */
    public RcvHolder setBackgroundRes(int viewId, int bgResId)
    {
        View view = findView(viewId);
